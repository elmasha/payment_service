...
const serviceAccount = require("./serviceAccountKeys/meatproserviceAccount.js");
...
app.post("/stk", access, _urlencoded, function(req, res) {
    ...
    request({
            ...
            json: {
                ...
                CallBackURL: "https://paymentservice-production-75bf.up.railway.app/meatpro/stk_callback",
